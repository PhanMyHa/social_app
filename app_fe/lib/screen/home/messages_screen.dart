...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  final List<Map<String, dynamic>> recentMatches = [
    ...
    {"name": "Match 1", "count": 0, "isHeart": false, "color": Colors.grey.shade300},
    {"name": "Match 2", "count": 0, "isHeart": false, "color": Colors.grey.shade300},
    {"name": "Match 3", "count": 0, "isHeart": false, "color": Colors.grey.shade300},
    {"name": "Match 4", "count": 0, "isHeart": false, "color": Colors.grey.shade300},
  ];

  // Dữ liệu mô phỏng Recent Messages
  final List<Map<String, dynamic>> recentMessages = [
    {"name": "Alfredo Calzoni", "message": "What about that new jacket if I ...", "time": "09:18", "isOnline": true},
    {"name": "Clara Hazel", "message": "I know right 😊", "time": "12:44", "isOnline": false},
    {"name": "Brandon Aminoff", "message": "I've already registered, can't wai...", "time": "08:06", "isOnline": true},
    {"name": "Amina Mina", "message": "It will have two lines of heading ...", "time": "09:32", "isOnline": false},
    {"name": "Alfredo Calzoni", "message": "What about that new jacket if I ...", "time": "09:18", "isOnline": true},
    {"name": "Clara Hazel", "message": "I know right 😊", "time": "12:44", "isOnline": false},
    {"name": "Brandon Aminoff", "message": "I've already registered, can't wai...", "time": "08:06", "isOnline": true},
    {"name": "Amina Mina", "message": "It will have two lines of heading ...", "time": "09:32", "isOnline": false},
        ...
        child: data['isHeart']
            ? Column(
                ...
                children: [
                  ...
                  Text(data['count'].toString(), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ],
              )
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // Thời gian
          Text(data['time'], style: TextStyle(fontSize: 12, color: Colors.grey[500])),
        ],
      ),
    );
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children:
                      recentMatches.map(_buildMatchCircle).toList(),
                ),
              ),
      ...
      Expanded(
        child: Container(
          ...
          child: ListView(
            ...
            children:
                recentMessages.map(_buildMessageRow).toList(),
          ),
        ),
      ),
    ],
