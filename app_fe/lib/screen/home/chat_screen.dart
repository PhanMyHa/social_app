...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final Color primaryPurple = Color.fromARGB(255, 172, 99, 144);
  ...
  Widget _buildAudioMessage(String type, int duration) {
    ...
    final Color bubbleColor = isSent
        ? primaryRed
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () =>
                    setState(() => _chatState = 1), // Quay lại Text mode
              ...
              CircleAvatar(
                ...
                child: IconButton(
                  ...
                  onPressed: () =>
                      setState(() => _chatState = 1), // Gửi và quay lại
                ),
              ),
            ],
          ),
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              GestureDetector(
                onTap: () =>
                    setState(() => _chatState = 2), // Chuyển sang Audio mode
                child: CircleAvatar(
                  backgroundColor: primaryRed,
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                    'assets/swirl_pattern_placeholder.png',
                  ), // Thay thế bằng ảnh thực tế nếu có
                  fit: BoxFit.cover,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final data =
                      messages[messages.length - 1 - index]; // Đảo ngược thứ tự
