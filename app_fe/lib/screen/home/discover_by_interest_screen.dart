...
class DiscoverByInterestScreen extends StatefulWidget {
  @override
  _DiscoverByInterestScreenState createState() =>
      _DiscoverByInterestScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: interestStats.map(_buildInterestRow).toList()),
      ),
    );
  }
}
